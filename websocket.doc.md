...
| /topic/game/{id}/updatedBoard | Sends the updated gameboard after a guess. | updatedboard: List <Card> <- list of all cards on teh board, each containing a word, color and guessed status. |
